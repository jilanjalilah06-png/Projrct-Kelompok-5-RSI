...
class _VirtualAssistantPageState extends State<VirtualAssistantPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final appbarBg = isDark ? const Color(0xFF1E1E1E) : _green;
    ...
    return Align(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isUser
              ? _VirtualAssistantPageState._green
...
class _FormattedText extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final style = TextStyle(
      color: isUser
          ? Colors.white
          : (isDark ? Colors.white : _VirtualAssistantPageState._title),
      fontSize: 14,
      height: 1.4,
    );
...
class _InputBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final inputBg = isDark ? const Color(0xFF2A2A2A) : const Color(0xFFF2F4F7);
    final textColor = isDark ? Colors.white : const Color(0xFF001A3D);
