...
class _AgriAsistenBotWidgetState extends State<AgriAsistenBotWidget>
  ...
  Widget _buildChatWindow(bool isMobile, Size size) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: isDark ? const Color(0xFF1E1E1E).withValues(alpha: 0.9) : Colors.white.withValues(alpha: 0.85),
  ...
  Widget _buildChatBubble(bool isUser, String text) {
    ...
    return Align(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isUser ? AgriColors.primary : (isDark ? const Color(0xFF2A2A2A) : Colors.white),
  ...
  Widget _formatMessageText(String text, bool isUser) {
    ...
    final style = TextStyle(
      color: isUser ? Colors.white : (isDark ? Colors.white : AgriColors.textDark),
      fontSize: 13.5,
      height: 1.4,
    );
