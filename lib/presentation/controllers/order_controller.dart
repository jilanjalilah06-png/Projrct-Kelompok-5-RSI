...
class OrderController extends ChangeNotifier {
  ...
  Future<bool> createPayment(int orderId) async {
    _isLoading = true;
    _lastError = null;
    notifyListeners();

    try {
      final updatedOrder = await _orderRepository.createPayment(orderId);
  ...
  Future<bool> simulatePayment(int orderId) async {
    _isLoading = true;
    _lastError = null;
    notifyListeners();

    try {
      final updatedOrder = await _orderRepository.simulatePayment(orderId);
