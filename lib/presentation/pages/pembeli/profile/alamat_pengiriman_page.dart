      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  color: isPrimary ? _green : (isDark ? const Color(0xFF2A2A2A) : const Color(0xFFF2F4F7)),
                  borderRadius: BorderRadius.circular(8),
                ),
                child: Text(
                  addr['label'] ?? '',
                  style: TextStyle(
                    color: isPrimary ? Colors.white : (isDark ? Colors.white70 : const Color(0xFF667085)),
                    fontSize: 12,
              ...
              PopupMenuButton<String>(
                ...
                itemBuilder: (context) => [
                  PopupMenuItem(
                    ...
                    child: Row(
                      children: [
                        Icon(Icons.edit_outlined, size: 18, color: isDark ? Colors.white70 : const Color(0xFF667085)),
                        const SizedBox(width: 8),
                  ...
                  if (!isPrimary)
                    PopupMenuItem(
                      ...
                      child: Row(
                        children: [
                          Icon(Icons.star_outline, size: 18, color: isDark ? Colors.white70 : const Color(0xFF667085)),
                          const SizedBox(width: 8),
                          Text('Jadikan Utama', style: TextStyle(color: isDark ? Colors.white : Colors.black)),
                        ],
                      ),
                    ),
                  const PopupMenuItem(
                ...
                icon: Icon(Icons.more_vert, color: isDark ? Colors.white38 : const Color(0xFF98A2B3), size: 20),
              ),
            ],
          ),
          ...
          Text(
            ...
            style: TextStyle(
              fontSize: 13,
              color: isDark ? Colors.white60 : const Color(0xFF344054),
              height: 1.5,
            ),
          ),
        ],
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: isDark ? Colors.white10 : _green.withValues(alpha: 0.3),
            width: 1.5,
