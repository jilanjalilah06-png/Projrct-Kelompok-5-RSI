...
class _InformasiPribadiPageState extends State<InformasiPribadiPage> {
  ...
  void initState() {
    ...
    _nameCtrl = TextEditingController(text: user?.name ?? 'Aryo');
    _emailCtrl = TextEditingController(text: user?.email ?? 'aryo@agriconnect.id');
    _phoneCtrl = TextEditingController(text: user?.phone ?? '0856-7890-1234');
  }
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  user?.email ?? 'aryo@agriconnect.id',
                  style: const TextStyle(
                    fontSize: 13,
      ...
      children: [
        ...
        TextField(
          ...
          decoration: InputDecoration(
            ...
            filled: true,
            fillColor: _isEditing ? Colors.white : _greenLight.withValues(alpha: 0.5),
            contentPadding: const EdgeInsets.symmetric(horizontal: 16, vertical: 14),
            border: OutlineInputBorder(
              borderRadius: BorderRadius.circular(14),
              borderSide: BorderSide(
                color: _isEditing ? _green : const Color(0xFFE4E7EC),
              ),
            ),
