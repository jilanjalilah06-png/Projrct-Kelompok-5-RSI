...
class _ManageCommoditiesScreenState extends State<ManageCommoditiesScreen> {
  ...
  // Fixed commodity data — only Padi, Padi Premium, Jagung, Jagung Premium
  // Prices match petani & pembeli pages
  static const List<Map<String, dynamic>> _commodities = [
    {
      'name': 'Padi',
      'grade': 'Standar',
      'stock': 100,
          ...
          children: [
            ...
            GridView.builder(
              ...
              itemBuilder: (context, i) {
                return _CommodityCard(commodity: _commodities[i]);
              },
            ),
                      ...
                      rows: _commodities.map((c) {
                        ...
                        return DataRow(cells: [
                          DataCell(Row(
                            ...
                            children: [
                              Icon(c['icon'] as IconData, size: 16, color: _greenAccent),
